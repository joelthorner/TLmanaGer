...
$('head').append(`
	<style>
		.swal2-question.swal2-animate-question-icon {
			width: 10rem;
			height: 10rem;
			background-image: url('${chrome.extension.getURL('img/homer-panic.jpg')}');
			background-size: cover;
			background-position: center;
			margin: 1em auto 1em;
		}
		.swal2-question.swal2-animate-question-icon:before {
			display: none;
		}
