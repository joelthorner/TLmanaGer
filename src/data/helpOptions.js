export default {
  ...
  sandboxLoginButtons: {
    ...
    content: `
      <a href="${chrome.extension.getURL("img/help/sandboxButtons.jpg")}" target="_blank">
        <img class="img-thumbnail" src="${chrome.extension.getURL("img/help/sandboxButtons.jpg")}">
      </a>
