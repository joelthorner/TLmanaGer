export default {
  coolTicketSubmit: {
    ...
    priority: 301,
    category: 'zendesk',
    image: chrome.runtime.getURL('img/optionsData/coolTicketSubmit.jpg'),
  ...
  ticketPriorityHighlightColors: {
    ...
    priority: 302,
    category: 'zendesk',
    image: chrome.runtime.getURL('img/optionsData/ticketPriorityHighlightColors.jpg'),
  ...
  background: {
    ...
    priority: 100,
    category: 'logicommerce',
    image: chrome.runtime.getURL('img/optionsData/background.jpg'),
  ...
  developerBar: {
    ...
    priority: 101,
    category: 'logicommerce',
    image: chrome.runtime.getURL('img/optionsData/developerBar.jpg'),
    title: "Developer bar",
  ...
  sandboxLoginButtons: {
    ...
    priority: 102,
    category: 'logicommerce',
    image: chrome.runtime.getURL('img/optionsData/sandboxLoginButtons.jpg'),
  ...
  pagesWindowBetter: {
    ...
    priority: 103,
    category: 'logicommerce',
    image: chrome.runtime.getURL('img/optionsData/pagesWindowBetter.jpg'),
  ...
  bigControlInputs: {
    ...
    priority: 105,
    category: 'logicommerce',
    image: chrome.runtime.getURL('img/optionsData/bigControlInputs.jpg'),
  ...
  autoForceView: {
    ...
    image: chrome.runtime.getURL('img/optionsData/autoForceView.jpg'),
  ...
  flushRedisIgdDomain: {
    ...
    priority: 201,
    category: 'fluidWebTools',
    image: chrome.runtime.getURL('img/optionsData/flushRedisIgdDomain.jpg'),
  ...
  dumpAutoScroll: {
    ...
    priority: 202,
    category: 'fluidWebTools',
    image: chrome.runtime.getURL('img/optionsData/dumpAutoScroll.jpg'),
  ...
  getFontWesomeIcons: {
    ...
    priority: 400,
    category: 'others',
    image: chrome.runtime.getURL('img/optionsData/getFontWesomeIcons.jpg'),
